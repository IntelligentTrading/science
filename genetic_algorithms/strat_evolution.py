...
def evaluate_dogenauts_wow(doge_folder, evaluation_data):
    ...
    for hof_filename in os.listdir(doge_folder):
        if not hof_filename.endswith("hof.p"):
            continue
        try:
        ...
        for individual in hof:
            ...
            try:
                ...
                evaluation = strat.evaluate(start_cash, start_crypto, evaluation_data.start_time, evaluation_data.end_time, False, False)
...
if __name__ == "__main__":
    ...
    evaluate_dogenauts_wow(validation_data)

...
class Evaluation:
    def __init__(self, strategy, transaction_currency, counter_currency,
        ...
        self.avg_profit_per_trade_pair, self.num_sells = self.execute_orders(self.orders)
        if verbose:
    ...
    def execute_orders(self, orders):
        ...
        end_cash = cash
        end_crypto = crypto
        return num_trades, end_cash, end_crypto, end_price, num_profitable_trades, avg_profit_per_trade_pair, num_sells
...
class ComparativeEvaluationOneSignal:
    ...
    def generate_strategy_and_evaluation(self, signal_type, transaction_currency, counter_currency, start_cash, start_crypto,
        ...
        strategy = generate_strategy(signal_type, transaction_currency, counter_currency, start_time, end_time, horizon,
        ...
        for horizon in horizons:
            ...
            for signal_type in signal_types:
                if signal_type == SignalType.RSI:
                    for overbought_threshold in rsi_overbought_values:
                        for oversold_threshold in rsi_oversold_values:
                            strategy = generate_strategy(signal_type, transaction_currency, counter_currency,
